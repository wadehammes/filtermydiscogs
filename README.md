...
**Agents (Cursor):** [AGENTS.md](./AGENTS.md). Cursor rules and skills live under [`.cursor/`](./.cursor/). Use the task map in [`docs/handbook/llms.md`](./docs/handbook/llms.md) to route work to the right handbook chapter.
