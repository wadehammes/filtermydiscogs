...
| [`authenticated-crates.spec.ts`](../../e2e/authenticated-crates.spec.ts) | **`/crates`** hub + **`/crates/crate-1`** detail layout list (MSW **`crate-1`** aligned with E2E collection; reorder handles + section insert controls; **`PUT /api/crates/:id/layout`** stubbed in [`handlers/crates.ts`](../../src/tests/msw/handlers/crates.ts)) |
