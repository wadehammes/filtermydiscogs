...
| [`createDefaultCrateApiHandlers`](../../src/tests/msw/handlers/crates.ts) / [`createDefaultAuthHandlers`](../../src/tests/msw/handlers/auth.ts) | Playwright / browser worker presets | Opt-in E2E mocking via [`mswBrowserWorker`](../../src/tests/msw/browser.ts) |
