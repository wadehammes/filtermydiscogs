...
- **Theme files** ([`src/styles/themes/`](../../src/styles/themes/)):
  ...
  - **`rating-star.css`** — **`--rating-star`** / **`--rating-star-muted`** for collection rating UI (gold on light palettes, brighter gold on dark).
...
- **Collection rating stars** ([`ReleaseRatingPicker`](../../src/components/ReleaseRatingPicker/ReleaseRatingPicker.component.tsx), community average in [`ReleaseHeroRatingsRow`](../../src/components/ReleaseHeroRatingsRow/ReleaseHeroRatingsRow.component.tsx)): filled stars use **`--rating-star`** (rich gold on light palettes, brighter gold on dark via **`light-dark()`** in [`rating-star.css`](../../src/styles/themes/rating-star.css)); empty/hover-outline stars use **`--rating-star-muted`**. Do not tie rating stars to **`--primary`** or **`--foreground`**.
