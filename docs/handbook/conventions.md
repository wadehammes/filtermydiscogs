...
| [`global/`](../../src/styles/global/) | Side-effect globals loaded via **`global.css`**: **`pills.css`**, **`sonner.css`**, **`base-ui-setup.css`**, **`theming.css`** (utility classes composed from modules) |
