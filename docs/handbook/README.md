...
**For tools and LLMs:** **[llms.md](llms.md)** has a compact **task → chapter** map and a short copy-paste instruction blurb. **[AGENTS.md](../../AGENTS.md)** requires reading this handbook before any work in the repo.
