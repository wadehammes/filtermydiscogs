...
- **Root error UI**: [`error.tsx`](../../src/app/error.tsx) (under Providers; self-contained [`error-boundary.module.css`](../../src/styles/modules/error-boundary.module.css), no **`Page`**). [`global-error.tsx`](../../src/app/global-error.tsx) replaces the root layout — own `html`/`body`, no Providers, no **`src/components`** imports (isolated client chunk; [`global-error.module.css`](../../src/app/global-error.module.css) with self-contained styles; dev-only details via [`isLocalDevHost()`](../../src/utils/isLocalDevHost.ts) only). Theme: **`useLayoutEffect`** + [`applyThemeFromStorage()`](../../src/utils/applyThemeFromStorage.ts) (uses [`resolveThemeInitAttribute`](../../src/utils/themeAppearance.ts), same rules as generated [`public/theme-init.js`](../../public/theme-init.js); no **`<script>`** — client components cannot execute head scripts in React 19).
