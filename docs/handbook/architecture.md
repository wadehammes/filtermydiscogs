...
- **Root error UI**: [`error.tsx`](../../src/app/error.tsx) (under Providers). [`global-error.tsx`](../../src/app/global-error.tsx) replaces the root layout — own `html`/`body`, no Providers, no **`src/components`** imports (isolated client chunk; [`global-error.module.css`](../../src/app/global-error.module.css) with self-contained styles; dev-only details via [`isLocalDevHost()`](../../src/utils/isLocalDevHost.ts) only).
