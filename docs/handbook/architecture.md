...
Topic-specific constants alongside root [`src/constants.ts`](../../src/constants.ts): [`sorting.ts`](../../src/constants/sorting.ts) (`SortValues`), [`mosaic.ts`](../../src/constants/mosaic.ts).
