...
| Release detail / tracklist / playback | [`src/app/api/release/[id]/route.ts`](../../src/app/api/release/[id]/route.ts) (+ [`route.spec.ts`](../../src/app/api/release/[id]/route.spec.ts)), [`src/components/ReleaseModal/`](../../src/components/ReleaseModal/), [`src/components/ReleasePlayback/`](../../src/components/ReleasePlayback/), [`src/context/releasePlayback.context.tsx`](../../src/context/releasePlayback.context.tsx), [`src/hooks/useSelectedReleaseModal.hook.ts`](../../src/hooks/useSelectedReleaseModal.hook.ts), [`src/utils/releaseModalUrl.ts`](../../src/utils/releaseModalUrl.ts), [`src/utils/releasePlayback.ts`](../../src/utils/releasePlayback.ts), [`src/utils/playbackQueue.ts`](../../src/utils/playbackQueue.ts), [`src/utils/similarReleases.ts`](../../src/utils/similarReleases.ts), [`src/utils/releasePlaybackStorage.ts`](../../src/utils/releasePlaybackStorage.ts), [`src/types/playbackQueue.types.ts`](../../src/types/playbackQueue.types.ts), [`discogs-release-detail.types.ts`](../../src/types/discogs-release-detail.types.ts) |
