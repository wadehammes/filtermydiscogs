...
| [`src/styles/`](../../src/styles/) | Global CSS, theme tokens ([`themes/base.css`](../../src/styles/themes/base.css), [`colors.css`](../../src/styles/themes/colors.css), [`theming.css`](../../src/styles/theming.css)), shared modules ([`typography.module.css`](../../src/styles/typography.module.css), [`accessibility.module.css`](../../src/styles/accessibility.module.css), [`dashboard-card.module.css`](../../src/styles/dashboard-card.module.css), nav/segmented controls), Stylelint custom properties. |
...
| Clear user data (Settings / About / Legal) | [`useClearAllUserData`](../../src/hooks/useClearAllUserData.hook.ts), [`clearData`](../../src/api/helpers.ts), [`POST /api/auth/clear-data`](../../src/app/api/auth/clear-data/route.ts) |
...
| Change filter logic | [`computeFilterDerivedState.ts`](../../src/utils/computeFilterDerivedState.ts), [`releaseSearchIndex.ts`](../../src/utils/releaseSearchIndex.ts), [`releaseFilterMatchers.ts`](../../src/utils/releaseFilterMatchers.ts), [`filterReleases.ts`](../../src/utils/filterReleases.ts), [`computeFacetOptions.ts`](../../src/utils/computeFacetOptions.ts), [`filters.atoms.ts`](../../src/atoms/filters.atoms.ts), [`filters.types.ts`](../../src/types/filters.types.ts) |
