...
| Release detail / tracklist / playback | [`src/app/api/release/[id]/route.ts`](../../src/app/api/release/[id]/route.ts) (+ [`route.spec.ts`](../../src/app/api/release/[id]/route.spec.ts)), [`ReleaseModal/`](../../src/components/ReleaseModal/), [`ReleaseTracklist/`](../../src/components/ReleaseTracklist/), [`GlobalPlaybackDock/`](../../src/components/GlobalPlaybackDock/), [`ReleaseMiniPlayer/`](../../src/components/ReleaseMiniPlayer/), [`PlaybackPageShell/`](../../src/components/PlaybackPageShell/), [`src/context/releasePlayback.context.tsx`](../../src/context/releasePlayback.context.tsx), [`src/hooks/useSelectedReleaseModal.hook.ts`](../../src/hooks/useSelectedReleaseModal.hook.ts), [`src/hooks/queries/useCollectionReleaseByInstanceId.hook.ts`](../../src/hooks/queries/useCollectionReleaseByInstanceId.hook.ts), [`src/utils/collectionReleaseLookup.ts`](../../src/utils/collectionReleaseLookup.ts), [`src/utils/releaseModalUrl.ts`](../../src/utils/releaseModalUrl.ts), [`src/utils/releasePlayback.ts`](../../src/utils/releasePlayback.ts), [`src/utils/playbackQueue.ts`](../../src/utils/playbackQueue.ts), [`src/utils/youtubeIframeEvents.ts`](../../src/utils/youtubeIframeEvents.ts), [`src/utils/similarReleases.ts`](../../src/utils/similarReleases.ts), [`src/utils/releasePlaybackStorage.ts`](../../src/utils/releasePlaybackStorage.ts), [`src/types/playbackQueue.types.ts`](../../src/types/playbackQueue.types.ts), [`discogs-release-detail.types.ts`](../../src/types/discogs-release-detail.types.ts) |
| DJ metadata (BPM/key via GetSongBPM) | [`TrackDjMetadata/`](../../src/components/TrackDjMetadata/), [`useReleaseTrackDjMetadata.hook.ts`](../../src/hooks/useReleaseTrackDjMetadata.hook.ts), [`useShowDjMetadataOnTracks.hook.ts`](../../src/hooks/useShowDjMetadataOnTracks.hook.ts), [`useTrackMetadataQuery.ts`](../../src/hooks/queries/useTrackMetadataQuery.ts), [`trackMetadataLookup.ts`](../../src/utils/trackMetadataLookup.ts), [`getsongbpm.server.ts`](../../src/lib/getsongbpm.server.ts), [`POST /api/track-metadata`](../../src/app/api/track-metadata/route.ts) |
