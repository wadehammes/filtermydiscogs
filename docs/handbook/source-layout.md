...
| Add a client API method | Implementation in [`src/api/endpoints/`](../../src/api/endpoints/), expose on **`api`** in [`src/api/urls.ts`](../../src/api/urls.ts) |
...
| Release detail / tracklist / playback | [`src/app/api/release/[id]/route.ts`](../../src/app/api/release/[id]/route.ts) (+ [`route.spec.ts`](../../src/app/api/release/[id]/route.spec.ts)), [`ReleaseModal/`](../../src/components/ReleaseModal/), [`ReleaseTracklist/`](../../src/components/ReleaseTracklist/), [`GlobalPlaybackDock/`](../../src/components/GlobalPlaybackDock/), [`ReleaseMiniPlayer/`](../../src/components/ReleaseMiniPlayer/), [`PlaybackPageShell/`](../../src/components/PlaybackPageShell/), [`src/context/releasePlayback.context.tsx`](../../src/context/releasePlayback.context.tsx), [`src/hooks/useSelectedReleaseModal.hook.ts`](../../src/hooks/useSelectedReleaseModal.hook.ts), [`src/hooks/queries/useCollectionReleaseByInstanceId.hook.ts`](../../src/hooks/queries/useCollectionReleaseByInstanceId.hook.ts), [`src/utils/collectionReleaseLookup.ts`](../../src/utils/collectionReleaseLookup.ts), [`src/utils/releaseModalUrl.ts`](../../src/utils/releaseModalUrl.ts), [`src/utils/releaseHeaderMetadata.ts`](../../src/utils/releaseHeaderMetadata.ts), [`src/utils/releasePlayback.ts`](../../src/utils/releasePlayback.ts), [`src/utils/playbackQueue.ts`](../../src/utils/playbackQueue.ts), [`src/utils/youtubeIframeEvents.ts`](../../src/utils/youtubeIframeEvents.ts), [`src/utils/similarReleases.ts`](../../src/utils/similarReleases.ts), [`src/utils/releasePlaybackStorage.ts`](../../src/utils/releasePlaybackStorage.ts), [`src/types/playbackQueue.types.ts`](../../src/types/playbackQueue.types.ts), [`discogs-release-detail.types.ts`](../../src/types/discogs-release-detail.types.ts) |
...
| Clear user data (Settings / About / Legal) | [`useClearAllUserData`](../../src/hooks/useClearAllUserData.hook.ts), [`api.clearData`](../../src/api/urls.ts), [`POST /api/auth/clear-data`](../../src/app/api/auth/clear-data/route.ts) |
| Settings page | [`SettingsClient`](../../src/components/Settings/SettingsClient.component.tsx), [`/settings`](../../src/app/settings/page.tsx) |
| Owner crates pages | [`CratesClient`](../../src/components/Crates/CratesClient.component.tsx), [`CrateDetailClient`](../../src/components/Crates/CrateDetailClient.component.tsx), [`CrateLayoutList`](../../src/components/Crates/CrateLayoutList.component.tsx), [`/crates`](../../src/app/crates/page.tsx), [`/crates/[id]`](../../src/app/crates/[id]/page.tsx) |
| Crate layout helpers | [`crate-layout.ts`](../../src/lib/crate-layout.ts), [`crate-layout.server.ts`](../../src/lib/crate-layout.server.ts), [`PUT /api/crates/[id]/layout`](../../src/app/api/crates/[id]/layout/route.ts) |
| Crate hub preview thumbs | [`crate-preview.ts`](../../src/lib/crate-preview.ts), [`crate-preview.server.ts`](../../src/lib/crate-preview.server.ts) — first-three cover URLs for **`GET /api/crates`** |
...
| Add a React Query read hook | [`src/hooks/queries/`](../../src/hooks/queries/) |
...
| Large providers (playback / crates) | Hooks: [`releasePlayback.context.tsx`](../../src/context/releasePlayback.context.tsx), [`crate.context.tsx`](../../src/context/crate.context.tsx), [`useCrateProvider.hook.ts`](../../src/hooks/useCrateProvider.hook.ts); contexts: [`releasePlaybackContexts.tsx`](../../src/context/releasePlaybackContexts.tsx), [`crateContexts.tsx`](../../src/context/crateContexts.tsx); types: [`crate.context.types.ts`](../../src/context/crate.context.types.ts); playback session state: [`playbackSessionState.ts`](../../src/utils/playbackSessionState.ts) (+ [`syncPlaybackSessionRefs.ts`](../../src/utils/syncPlaybackSessionRefs.ts)); providers: [`ReleasePlaybackProvider.component.tsx`](../../src/context/ReleasePlaybackProvider.component.tsx), [`CrateProvider.component.tsx`](../../src/context/CrateProvider.component.tsx) — see [patterns.md → Large context providers](patterns.md#large-context-providers-playback-crates-notes-editor) |
