...
export namespace Models {
  export type public_Users = {
    discogsUserId: CodecTypes['pg/int4@1']['output'];
    username: CodecTypes['pg/text@1']['output'];
    createdAt: TimestampString<3>;
    updatedAt: TimestampString<3>;
    preferences: CodecTypes['pg/jsonb@1']['output'];
    loginCount: CodecTypes['pg/int4@1']['output'];
    supportToastDismissed: CodecTypes['pg/bool@1']['output'];
    supportToastPending: CodecTypes['pg/bool@1']['output'];
    lastSeenAt: TimestampString<3> | null;
    crates: public_Crates[];
    readonly [RelationKeys]?: 'crates';
  };
  export type public_Crates = {
    ...
    createdAt: TimestampString<3>;
    updatedAt: TimestampString<3>;
    private: CodecTypes['pg/bool@1']['output'];
    username: CodecTypes['pg/text@1']['output'] | null;
    packedEnabled: CodecTypes['pg/bool@1']['output'];
    notes: CodecTypes['pg/text@1']['output'] | null;
    crateReleases: public_CrateReleases[];
    crateSetMarkers: public_CrateSetMarkers[];
    user: public_Users;
    readonly [RelationKeys]?: 'crateReleases' | 'crateSetMarkers' | 'user';
  };
  export type public_CrateReleases = {
    userId: CodecTypes['pg/int4@1']['output'];
    crateId: CodecTypes['pg/text@1']['output'];
    instanceId: CodecTypes['pg/text@1']['output'];
    releaseData: CodecTypes['pg/jsonb@1']['output'];
    addedAt: TimestampString<3>;
    foundAt: TimestampString<3> | null;
    sortOrder: CodecTypes['pg/int4@1']['output'];
    crates: public_Crates;
    readonly [RelationKeys]?: 'crates';
  };
  export type public_CrateSetMarkers = {
    userId: CodecTypes['pg/int4@1']['output'];
    crateId: CodecTypes['pg/text@1']['output'];
    id: CodecTypes['pg/text@1']['output'];
  ...
  export type public_ProductAnalyticsDailyRollups = {
    date: CodecTypes['pg/date-string@1']['output'];
    dimensionType: CodecTypes['pg/text@1']['output'];
    dimensionKey: CodecTypes['pg/text@1']['output'];
    eventCount: CodecTypes['pg/int4@1']['output'];
    readonly [RelationKeys]?: never;
  };
  export type public_ProductAnalyticsEvents = {
    id: CodecTypes['pg/text@1']['output'];
    ...
    pagePath: CodecTypes['pg/text@1']['output'] | null;
...
export declare const models: {
  public: {
    ...
    Crates: Models.public_Crates;
    CrateReleases: Models.public_CrateReleases;
    CrateSetMarkers: Models.public_CrateSetMarkers;
    PrismaMigrations: Models.public_PrismaMigrations;
    ProductAnalyticsDailyRollups: Models.public_ProductAnalyticsDailyRollups;
    ProductAnalyticsEvents: Models.public_ProductAnalyticsEvents;
  };
};
