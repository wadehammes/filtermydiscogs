    ...
    <div className={pageStyles.container}>
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            <li>
              Your collection data is just for showing you your records. That's
              it.
            </li>
            <li>
              I don't analyze it, mine it, or send it anywhere. Your music taste
              stays yours.
            </li>
            <li>
            ...
            <li>
              Want to nuke everything? Hit "Clear All Data" below and I'll wipe
              your crates from the database. Gone forever.
            </li>
          </ul>
